        ...
        <div>
            <div className="row">
                ...
                <div className="col-8">
                    ...
                    <h1>Edit Product or <button className='btn btn-primary btn-sm'><Link to='/' ><span className='text-light'>Home</span></Link></button></h1>
                    ...
                    <div>
                        ...
                        {
                            manageProducts.map(pd => <ProductAction edit='true' product={pd} key={pd._id}></ProductAction>)
                        }
                    </div>
                    {
